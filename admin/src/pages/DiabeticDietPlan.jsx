...
const DiabeticDietPlan = () => {
  ...
  const handleNavigate = () => {
    ...
    navigate("/subscribe-confirm", { state: planData }); // ✅ fixed variable name
  };
      ...
      <div className="flex flex-col lg:flex-row items-center justify-center gap-10">
        ...
        >
          ...
          <img
            ...
            alt="Diabetic Diet Plan"
            className="rounded-2xl shadow-xl w-full object-cover transition duration-500"
          />
          <motion.p
          ...
          >
            Manage your sugar the smart way! Swap’s {mealOption} Diabetic Diet
            Plan includes balanced, low-GI meals tailored to support blood sugar
            control while keeping flavors intact.
          </motion.p>
        </motion.div>
        ...
        >
          <h2 className="text-3xl font-bold">Diabetic Diet Plan</h2>
          ...
          {/* Days Option */}
          <div>
            <p className="font-semibold">Choose Days On Which You Want The Food</p>
            <div className="flex gap-2 mt-2">
