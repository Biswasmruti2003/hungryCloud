...
const WeightlossPlanCard = () => {
  ...
  const [orderDate, setOrderDate] = useState(""); // Added for start date if needed
  ...
  const handleNavigate = () => {
    const planData = {
      ...
      planName: "Weightloss Meal Plan",
    };
    navigate("/subscribe-confirm", { state: planData });
  };
    ...
    if (isLoggedIn) {
      navigate("/subscribe-confirm", {
        state: {
          mealOption,
          slot,
          duration: durations[0], // 3 day duration
          daysOption: "Custom",
  ...
  return (
    <section className="py-16 px-4 max-w-7xl mx-auto bg-white">
      ...
      <div className="flex flex-col lg:flex-row items-center justify-center gap-10">
        ...
        >
          <div
            className={`${tagColor} absolute top-0 left-0 text-white px-3 py-1 text-sm rounded-br-xl z-10`}
          >
            {tagText}
          </div>
          <img
          ...
          >
            Shed those extra kilos the tasty way! Swap’s {mealOption} Weightloss
            Plan is designed to help you achieve your goals while enjoying
            delicious, portion-controlled meals.
          </motion.p>
        </motion.div>
        <motion.div
          initial={{ x: 50, opacity: 0 }}
        ...
        >
          <h2 className="text-3xl font-bold">Weightloss Meal Plan</h2>
          <div className="flex flex-wrap gap-2 text-sm">
            <span className="bg-green-100 text-green-800 px-2 py-1 rounded">
              Weightloss
            </span>
            <span className="bg-green-100 text-green-800 px-2 py-1 rounded">{slot}</span>
            {isVeg && (
              <span className="bg-green-100 text-green-800 px-2 py-1 rounded">
                Low Cal Veg
              </span>
          ...
          <div>
            <p className="font-semibold">
              Choose Days On Which You Want The Food To Be Delivered:
            </p>
            <div className="flex gap-2 mt-2">
