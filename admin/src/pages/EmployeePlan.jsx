    ...
    <section className="bg-white py-16 px-4 max-w-7xl mx-auto relative">
      ...
      <div className="flex flex-col lg:flex-row items-center justify-center gap-10">
        ...
        >
          ...
          >
            Manage your energy and productivity smartly! Swap’s {mealOption}{" "}
            Office Employee Plan delivers delicious meals straight to your
            workplace.
          </motion.p>
        </motion.div>
        ...
        >
          <h2 className="text-3xl font-bold">Office Employee Meal Plan</h2>
