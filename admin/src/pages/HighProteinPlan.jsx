  ...
  return (
    <section className="bg-white py-16 px-4 max-w-7xl mx-auto relative">
      ...
      <div className="flex flex-col lg:flex-row items-center justify-center gap-10">
        ...
        >
          <div className={`absolute top-0 left-0 ${tagColor} text-white px-3 py-1 text-sm rounded-br-xl z-10`}>
            {tagText}
          </div>
          <img
            src={
          ...
          >
            Ready to power up your strength and stamina? Enter Swap's{" "}
            {mealOption} High Protein Plan, delivering a solid protein punch
            with every meal.
          </motion.p>
        </motion.div>
        ...
        >
          <h2 className="text-3xl font-bold">High Protein Meal Plan</h2>
          {/* Tags */}
          <div className="flex flex-wrap gap-2 text-sm">
            <span className="bg-green-100 text-green-800 px-2 py-1 rounded">High Protein</span>
            <span className="bg-green-100 text-green-800 px-2 py-1 rounded">Lunch</span>
            <span className="bg-green-100 text-green-800 px-2 py-1 rounded">Dinner</span>
            {isVeg && <span className="bg-green-100 text-green-800 px-2 py-1 rounded">Pure Veg</span>}
          </div>
